...
object App:
  ...
  /** Check the server-side phase and redirect if the current URL doesn't match.
    * This ensures users entering via direct URLs (e.g., /question, /final)
    * are redirected to the correct phase.
    */
